<template>
    <div>
        ...
        <header><span class="hd-left"></span><span class="test-type" @click="showPickcarType = true">{{carType}}</span>驾考宝典<span class="test-subject" @click="showPicktestType = true">{{testType}}</span></header>
        <div class="main">
